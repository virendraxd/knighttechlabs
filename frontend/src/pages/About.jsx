            ...
            <main>
                <section className="page-content light-bg">
                    ...
                    <div className="info-card"> 
                        <h3 style={{color: "var(--cyan)", fontSize: "1.2rem", marginBottom: "1rem", marginTop: "0"}}>The "People-First" Core</h3>
                    ...
                    <div className="info-card" >
                        <h3 style={{color: "var(--cyan)", fontSize: "1.2rem", marginBottom: "1rem", marginTop: "0"}}>Our Philosophy</h3>
