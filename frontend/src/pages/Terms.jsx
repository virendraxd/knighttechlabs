            ...
            <main>
                <section className="page-content light-bg">
                    ...
                    <div className="info-card">
                        <h3 style={{color: "var(--cyan)", fontSize: "1.2rem", marginBottom: "1rem", marginTop: "0"}}>Ethical Use Policy</h3>
                    ...
                    <div className="info-card">
                        <h3 style={{color: "var(--cyan)", fontSize: "1.2rem", marginBottom: "1rem", marginTop: "0"}}>Modifications</h3>
